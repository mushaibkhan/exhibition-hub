...
const TeamLedger = () => {
  const { role, isAdmin, internalLedger, addInternalTransaction, settleInternalTransaction } = useData();
  ...
  // (Assume payments are available from useData, e.g. payments array)
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Send from_name and to_name as raw strings (manual journal)
      const payload = {
